...
from perfil.utils.tools import parse_date, probably_same_entity, treat_birthday


class Command(ImportCsvCommand):

    help = (
        "Import CSV generated by: https://brasil.io/dataset/eleicoes-brasil/candidatos"
    )  # noqa
    model = Person
    bulk_size = 2 ** 10
    slice_csv = False
