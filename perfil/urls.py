...
from perfil.core.views import (
    ...
    CandidateElectoralIncomeHistory,
    home,
    national_stats,
    state_stats,
)
...
urlpatterns = [
    ...
    path(
        "api/electoral-income-history/candidate/<int:pk>/",
        CandidateElectoralIncomeHistory.get,
        name="api_candidate_electoral_income_history",
    ),
    path(
